...
<div class="row  d-md-none justify-content-center contact-info my-5">
    <div>
        <div class="m-auto text-center">
            <a href="#collapse1" data-toggle="collapse"><img class="img-fluid icoInfo mb-3"
                                                             src="public/images/icoInfo.png"
    ...
    <div class="contact-form my-5">
        <div class="row justify-content-between my-5 ">
            ...
            <div class="col-lg-3 contact-info d-none d-lg-flex justify-content-center flex-column mx-4">
                ...
                <div>
                    <img class="img-fluid icoInfo mr-3" src="public/images/about/icoVehicule.png"
                         alt="Icone Voiture">Véhiculée et mobile
                </div>
            </div>
            <!--prise de contact-->
            <div class="col-lg-6 mx-4 ">
                ...
                <div class="input-group mb-3  d-flex flex-column flex-lg-row">
                    ...
                    <textarea class="form-control" placeholder="Envoyez moi votre message :)" rows="5" cols="40"
                              id="message" name="message" required><?php if (isset($_POST['message'])) {
                            echo $_POST['message'];
                        } ?></textarea>
                </div>
                ...
                <div class="d-flex justify-content-center">
                    <button type="submit" class="mt-3 btn text-white rounded " value="Envoyer"
...
<!-- script js -->
<script src="public/js/verifMail.js"></script>